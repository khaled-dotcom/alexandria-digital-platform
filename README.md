...
بيراقب مهلة الحل، وبيصعّده تلقائيًا لو اتأخر.
...
npm start                 # npm test بعد كده لو عايز تشغّل الـ ٤٥٩ اختبار (راجع tests/run-all.mjs)
```
...
src/
  migrations/          ترحيلات المخطط المرقّمة (001 → 004)
